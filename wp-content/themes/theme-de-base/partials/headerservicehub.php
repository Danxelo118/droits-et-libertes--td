...
<body>
    ...
    <div class="header">
        ...
        <img class="sante-hero" src="../pages-statiques-tristan/medias/services-heroo.jpg" alt="">
        <div class="title-sante">Services</div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="droits-sante.html" id="servicesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Luttes</a>
