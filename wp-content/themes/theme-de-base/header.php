...
<header>
 ...
 <div class="promo-banner" id="promo-banner">
    ...
    <video autoplay loop muted>
        <source src="../pages-statiques-tristan/medias/header.mp4" type="video/mp4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="news-hub.html" id="publicationDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Publications</a>
